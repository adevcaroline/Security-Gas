...
function autenticar(email, senha) {
    ...
    var instrucaoSql = `
    SELECT idUsuario, nome, email, fkRestaurante, nome_restaurante FROM usuario join restaurante on usuario.fkRestaurante = restaurante.idRestaurante WHERE email = '${email}' AND senha = '${senha}';
`;
