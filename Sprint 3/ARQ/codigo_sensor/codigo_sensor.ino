 int PINO_SENSOR_MQ2 = A5;// cria a variavel e seta o pino A0 do sensor
  int VALOR_MINIMO = 100;//cria uma variavel com a valor mínimo do sensor
...
void loop() {
  ...
  float porcentagem = (((float)(valorSensor - VALOR_MINIMO) / (VALOR_MAXIMO - VALOR_MINIMO)) * 100) - 15;//calcula o percentual da variacão
